...
export function ReservapagoComponent() {
  ...
  const handleWebpayPayment = async () => {
    try {
      // Primero, realiza la solicitud de transacción a Webpay
      ...
      if (response.ok) {
        ...
        // Guarda los detalles de la reserva localmente para usarlos en la confirmación
        ...
        // Envío del correo de confirmación una vez que la reserva ha sido confirmada
        try {
        ...
        // Redirige al usuario al URL de Webpay para completar el pago
